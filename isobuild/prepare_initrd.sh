...
#---------------------------------------------------------------------
# ABOUT:
# This script will create the necessary files for generating
# an initrd from /mnt/lfs per:
# https://www.linuxfromscratch.org/blfs/view/svn/postlfs/initramfs.html
#---------------------------------------------------------------------

echo "Generating mkinitramfs scripts:"

#---------------------------------------------------------------------
# /usr/sbin/mkinitramfs

echo "Generating /mnt/lfs/usr/sbin/mkinitramfs..."

cat > /mnt/lfs/usr/sbin/mkinitramfs << "EOF"
#!/bin/bash
...
chmod 0755 /mnt/lfs/usr/sbin/mkinitramfs

#---------------------------------------------------------------------
# /usr/share/mkinitramfs/init.in

echo "Generating /mnt/lfs//usr/share/mkinitramfs/init.in..."

mkdir -p /mnt/lfs/usr/share/mkinitramfs

cat > /mnt/lfs/usr/share/mkinitramfs/init.in << "EOF"
#!/bin/sh
